  ...
  return (
    <section className="hero-section">
      <div className="container">
        <h1 style={{ fontSize: '4rem', marginBottom: '1.5rem', color: 'var(--primary)' }}>
          FACULTY OF LAW
        </h1>
        <h2 style={{ fontSize: '2rem', color: '#fff', marginBottom: '2rem', fontWeight: '400' }}>
        ...
        <p style={{ maxWidth: '700px', margin: '0 auto 3rem', color: 'var(--text-secondary)', fontSize: '1.1rem' }}>
          ...
          A specialized archive for undergraduate projects, theses, and faculty publications.
        </p>
